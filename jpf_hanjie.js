...
function init() {
      ...
      // insert the htl code for the first puzzle table
      ...
      document.getElementById("solve").addEventListener("click", function () {
            //removing the inline background color style form each cell
...
function swapPuzzle(e) {
      if (confirm("You will lose all of your work on the puzzle! continue?")) {
            ...
            // retreve the id of the clicked button
            var puzzleID = e.target.id;

            // retreve the value of the clicked  button
            var puzzleTitle = e.target.value;
            document.getElementById("puzzleTitle").innerHTML = puzzleTitle;

            // display the puzzle based on the value of the puzzle id varible
            switch (puzzleID) {
                  case "puzzle1":
                        document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);
                        break;
...
function setupPuzzle() {
      ...
      for (var i = 0; i < puzzleCells.length; i++) {
            ...
            // set the cell background color in respponce to the mousedown event
      ...
      document.getElementById("peek").addEventListener("click", function () {
            // display incorrect white cells in oink
...
function setBackground(e) {
      ...
      // set the background based on  the keyboard key that we press
      if (e.shiftKey) {
...
//create a function to extend the backgorund and seta new backgorund color
